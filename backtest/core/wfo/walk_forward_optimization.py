...
class WalkForwardOptimization:
    ...
    def walk_forward(self, params: dict) -> tuple[pd.DataFrame, pd.Series]:
        ...
        portfolio = vbt.Portfolio.from_signals(
            ...
            high = self.backtest_data.iloc[self.oos_start_i:self.oos_end_i].price_high,
            low = self.backtest_data.iloc[self.oos_start_i:self.oos_end_i].price_low,
            entries = entries,
            exits = exits,
            freq = '30min',
    ...
    def optimize(self) -> tuple[dict, vbt.Portfolio]:
        ...
        portfolio = vbt.Portfolio.from_signals(
            ...
            high = self.backtest_data.iloc[self.is_start_i:self.is_end_i].price_high,
            low = self.backtest_data.iloc[self.is_start_i:self.is_end_i].price_low,
            entries = entries,
            exits = exits,
            freq = '30min',
            init_cash = self.strategy.backtest_params['init_cash'],
