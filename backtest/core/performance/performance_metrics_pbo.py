...
def sharpe_non_iid(rtns, bench=0, q=trading_hours, p_critical=0.05, log=True):
    """
...
def annual_geometric_returns(rtns, ann_factor=trading_hours, log=True):
    """
...
def annualized_pct_return(total_return, days, ann_factor=trading_hours):
    """
    Parameters:
        total_return:
...
def annualized_log_return(total_return, days, ann_factor=trading_hours):
    """
    Parameters:
        total_return:
...
def calmar_ratio(returns, factor=trading_hours, log=True):
    """
