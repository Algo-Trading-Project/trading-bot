...
class PairsTradingBackTester:
    ...
    def __is_cointegrated(self, 
                          symbol_id_1: str, 
                          symbol_id_2: str, 
                          p_val_thresh:float = 0.05, 
                          correlation_thresh:float = 0.9) -> Tuple[bool, dict]:                    
    ...
    def backtest(self, 
                 ...
                 is_end_i: int, 
                 oos_start_i: int, 
                 oos_end_i: int) -> Tuple[pd.DataFrame, pd.DataFrame]:
    ...
    def walk_forward_optimization(self, 
                                  ...
                                  symbol_id_2: str,
                                  in_sample_size: int,
                                  out_of_sample_size: int) -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]:
